...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{asset("/pages/img/logo-big-white.png" )}}"style="height: 25px;" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            {!! csrf_field() !!}
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="user@example.com" name="email" /> </div>
                <div class="form-group">
